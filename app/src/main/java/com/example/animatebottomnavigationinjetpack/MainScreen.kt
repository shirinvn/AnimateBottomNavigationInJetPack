...
fun CustomBottomNavigation() {
    Row(
        ...
        modifier = Modifier
            .height(80.dp)
            .paint(
                painter = painterResource(R.drawable.btn_nav),
                contentScale = ContentScale.FillHeight
            )
            .padding(horizontal = 40.dp)
    ) {
        listOf(Icons.Filled.DateRange, Icons.Filled.PlayArrow).map { image ->
            IconButton(onClick = { }) {
    ...
    Box(
        ...
        AnimatedFab(
            ...
            modifier = Modifier
                .padding(
                    ...
                    ) * FastOutSlowInEasing.transform(0f)
                ),
            opacity = LinearEasing.transform(0.2f)
        )
        ...
        AnimatedFab(
            ...
            modifier = Modifier.padding(
                PaddingValues(
                    bottom = 88.dp,
                ) * FastOutSlowInEasing.transform(0.1f)
            ),
